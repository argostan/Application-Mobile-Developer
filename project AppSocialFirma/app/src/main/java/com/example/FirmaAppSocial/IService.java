...
//retrofit2:librerie per la gestione dei servizi API REST
...
public interface IService {
    ...
    @FormUrlEncoded
    @POST("login_augusto.php")
    Call<LoginResponse> login(@Field("username") String username, @Field("password") String password);
    @FormUrlEncoded
    @POST("contatto.php")
    Call<ContattoResponse> contatto(@Field("nome") String nome, @Field("cognome") String cognome, @Field("email") String email, @Field("messaggio") String messaggio);
